        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-4">
              {/* Facebook */}
              <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-[#902bf5] transition">
              ...
              {/* Instagram */}
              <a href="#" aria-label="Instagram" className="text-gray-400 hover:text-[#902bf5] transition">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Twitter / X */}
              <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-[#902bf5] transition">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="#" aria-label="YouTube" className="text-gray-400 hover:text-[#902bf5] transition">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-gray-400">
              <li><Link to="/products" className="hover:text-[#902bf5] transition">All Products</Link></li>
              <li><Link to="/wishlist" className="hover:text-[#902bf5] transition">Wishlist</Link></li>
              <li><Link to="/cart" className="hover:text-[#902bf5] transition">Cart</Link></li>
              <li><Link to="/orders" className="hover:text-[#902bf5] transition">Orders</Link></li>
            </ul>
          </div>
